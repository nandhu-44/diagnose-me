      ...
      <div className="container flex h-14 px-12 py-2 bg-slate-300 items-center">
        <div className="flex flex-1 items-center justify-between">
          <div className="flex items-center space-x-2">
            <Link className="text-xl font-bold gradient-text hover:cursor-pointer" href={"/"}>Diagnose Me</Link>
          ...
          <div className="flex items-center space-x-4">
            <Avatar>
              <AvatarFallback className="bg-primary/10 text-primary">
                <Image src={userType === 'patient' ? '/patient.png' : '/doctor.png'} alt="User" height={100} width={100} className="rounded-full border-[3px] border-yellow-400" />
              </AvatarFallback>
            </Avatar>
            <Button 
              variant="ghost" 
